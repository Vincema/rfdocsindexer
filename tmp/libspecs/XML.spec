...
<keywordspec name="XML" type="LIBRARY" format="ROBOT" scope="GLOBAL" generated="2024-07-26T11:05:34+00:00" specversion="6" source="C:\Users\maire\AppData\Local\Packages\PythonSoftwareFoundation.Python.3.10_qbz5n2kfra8p0\LocalCache\local-packages\Python310\site-packages\robot\libraries\XML.py" lineno="45">
...
emits a warning and reverts back to using the standard ElementTree.</doc>
...
<kw name="Element Attribute Should Be" lineno="805">
...
<kw name="Element Attribute Should Match" lineno="830">
...
<kw name="Element Should Exist" lineno="616">
...
<kw name="Element Should Not Exist" lineno="631">
<arguments repr="source, xpath=., message=None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="source">
<name>source</name>
</arg>
...
<kw name="Element Should Not Have Attribute" lineno="851">
...
<kw name="Element Text Should Be" lineno="715">
...
<kw name="Element Text Should Match" lineno="742">
...
<kw name="Elements Should Be Equal" lineno="873">
<arguments repr="source, expected, exclude_children=False, normalize_whitespace=False, sort_children=False">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="source">
<name>source</name>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="expected">
...
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="sort_children=False">
...
``sort_children`` is new in Robot Framework 7.0.</doc>
<shortdoc>Verifies that the given ``source`` element is equal to ``expected``.</shortdoc>
</kw>
<kw name="Elements Should Match" lineno="917">
<arguments repr="source, expected, exclude_children=False, normalize_whitespace=False, sort_children=False">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="source">
<name>source</name>
</arg>
...
<kw name="Evaluate Xpath" lineno="1373">
...
<kw name="Get Child Elements" lineno="586">
<arguments repr="source, xpath=.">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="source">
<name>source</name>
</arg>
...
<kw name="Get Element" lineno="521">
<arguments repr="source, xpath=.">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="source">
<name>source</name>
</arg>
...
<kw name="Get Element Attribute" lineno="763">
...
<kw name="Get Element Attributes" lineno="785">
<arguments repr="source, xpath=.">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="source">
<name>source</name>
</arg>
...
<kw name="Get Element Count" lineno="604">
<arguments repr="source, xpath=.">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="source">
<name>source</name>
</arg>
...
<kw name="Get Element Text" lineno="646">
...
<kw name="Get Elements" lineno="564">
<arguments repr="source, xpath">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="source">
<name>source</name>
</arg>
...
<kw name="Get Elements Texts" lineno="695">
<arguments repr="source, xpath, normalize_whitespace=False">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="source">
<name>source</name>
</arg>
...
<kw name="Log Element" lineno="1320">

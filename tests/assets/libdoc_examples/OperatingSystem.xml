...
<keywordspec name="OperatingSystem" type="LIBRARY" format="ROBOT" scope="GLOBAL" generated="2023-04-17T12:52:22+00:00" specversion="4" source="/home/kali/Code/rfdocsindexer/.venv/lib/python3.10/site-packages/robot/libraries/OperatingSystem.py" lineno="38">
...
<keywords>
<kw name="Append To Environment Variable" lineno="982">
...
<kw name="Append To File" lineno="639">
...
<kw name="Copy Directory" lineno="911">
...
<kw name="Count Directories In Directory" lineno="1374">
...
<kw name="Count Files In Directory" lineno="1368">
<arguments repr="path, pattern=None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="Count Items In Directory" lineno="1357">
<arguments repr="path, pattern=None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="Create Binary File" lineno="613">
...
<kw name="Create Directory" lineno="696">
<arguments repr="path">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="Create File" lineno="576">
<arguments repr="path, content=, encoding=UTF-8">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="Directory Should Be Empty" lineno="523">
...
<kw name="Directory Should Exist" lineno="439">
<arguments repr="path, msg=None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="Directory Should Not Be Empty" lineno="535">
<arguments repr="path, msg=None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="Directory Should Not Exist" lineno="453">
<arguments repr="path, msg=None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="Empty Directory" lineno="681">
<arguments repr="path">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="Environment Variable Should Be Set" lineno="1029">
...
<kw name="Environment Variable Should Not Be Set" lineno="1039">
<arguments repr="name, msg=None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="name">
<name>name</name>
</arg>
...
<kw name="File Should Be Empty" lineno="547">
<arguments repr="path, msg=None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="File Should Exist" lineno="411">
<arguments repr="path, msg=None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="File Should Not Be Empty" lineno="561">
<arguments repr="path, msg=None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="File Should Not Exist" lineno="425">
<arguments repr="path, msg=None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="Get Binary File" lineno="293">
<arguments repr="path">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="Get Environment Variable" lineno="955">
...
<kw name="Get Environment Variables" lineno="1050">
<arguments repr="">
</arguments>
...
<kw name="Get File Size" lineno="1304">
<arguments repr="path">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="Get Modified Time" lineno="1215">
...
<kw name="Join Paths" lineno="1096">
...
<kw name="List Directories In Directory" lineno="1349">
...
<kw name="List Directory" lineno="1314">
<arguments repr="path, pattern=None, absolute=False">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="List Files In Directory" lineno="1342">
<arguments repr="path, pattern=None, absolute=False">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="Log Environment Variables" lineno="1059">
...
<kw name="Move Directory" lineno="940">
<arguments repr="source, destination">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="source">
<name>source</name>
</arg>
...
<kw name="Normalize Path" lineno="1112">
...
<kw name="Remove Directory" lineno="712">
...
<kw name="Remove Environment Variable" lineno="1014">
...
<kw name="Remove File" lineno="652">
<arguments repr="path">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="Remove Files" lineno="672">
...
<kw name="Run And Return Rc" lineno="196">
<arguments repr="command">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="command">
<name>command</name>
</arg>
...
<kw name="Run And Return Rc And Output" lineno="223">
<arguments repr="command">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="command">
<name>command</name>
</arg>
...
<kw name="Set Environment Variable" lineno="972">
...
<kw name="Set Modified Time" lineno="1257">
...
<kw name="Should Exist" lineno="373">
<arguments repr="path, msg=None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="Should Not Exist" lineno="386">
<arguments repr="path, msg=None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="Split Extension" lineno="1168">
<arguments repr="path">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="Split Path" lineno="1149">
<arguments repr="path">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
...
<kw name="Wait Until Created" lineno="495">
...
<kw name="Wait Until Removed" lineno="469">
<arguments repr="path, timeout=1 minute">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="path">
<name>path</name>
</arg>
